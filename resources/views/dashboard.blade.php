...
<head>
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('asset/remos/css/animate.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset/remos/css/animation.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset/remos/css/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset/remos/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset/remos/css/style.css') }}">



    <!-- Font -->
    <link rel="stylesheet" href="{{ asset('asset/remos/font/fonts.css') }}">

    <!-- Icon -->
    <link rel="stylesheet" href="{{ asset('asset/remos/icon/style.css') }}">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="{{ asset('asset/remos/images/favicon.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{ asset('asset/remos/images/favicon.png') }}">
...
<body class="body">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="{{ asset('asset/remos/images/logo/logo.png') }}" data-light="{{ asset('asset/remos/images/logo/logo.png') }}" data-dark="{{ asset('asset/remos/images/logo/logo-dark.png') }}" >
                        </a>
                    ...
                    <div class="section-menu-left-wrap">
                        ...
                        <div class="bot text-center">
                            <div class="wrap">
                                <div class="mb-20">
                                    <img src="{{ asset('asset/remos/images/menu-left/img-bot.png') }}" alt="">
                                </div>
                                <div class="mb-20">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{ asset('asset/remos/images/logo/logo.png') }}" data-light="{{ asset('asset/remos/images/logo/logo.png') }}" data-dark="{{ asset('asset/remos/images/logo/logo-dark.png') }}" data-width="154px" data-height="52px" data-retina="{{ asset('asset/remos/images/logo/logo@2x.png') }}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/17.png') }}" alt="">
                                                        </div>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/18.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/19.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/20.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/21.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/22.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset/remos/images/products/23.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Mega Pumpkin Bone</a>
                            ...
                            <div class="header-grid">
                                <div class="header-item country">
                                    <select class="image-select no-text">
                                        <option data-thumbnail="{{ asset('asset/remos/images/country/1.png') }}">ENG</option>
                                        <option data-thumbnail="{{ asset('asset/remos/images/country/9.png') }}">VIE</option>
                                    </select>
                                </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/avatar/user-11.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/avatar/user-12.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/avatar/user-13.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4" >
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-1.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-2.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-3.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-4.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-5.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-6.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-7.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-8.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{ asset('asset/remos/images/apps/item-9.png') }}" alt="">
                                                        </div>
                                                        <a href="#">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{ asset('asset/remos/images/avatar/user-1.png') }}" alt="">
                                                </span>
                                        ...
                                        <div class="wg-table table-top-product">
                                            <ul class="flex flex-column gap14">
                                                <li class="product-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/1.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        ...
                                                        <div class="country">
                                                            <img src="{{ asset('asset/remos/images/country/2.png') }}" alt="">
                                                        </div>
                                                        <div>
                                                ...
                                                <li class="product-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/2.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                        ...
                                                        <div class="country">
                                                            <img src="{{ asset('asset/remos/images/country/3.png') }}" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="body-title-2 mb-3">-15%</div>
                                                            <div class="text-tiny">$27.00</div>
                                                ...
                                                <li class="product-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/3.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                        ...
                                                        <div class="country">
                                                            <img src="{{ asset('asset/remos/images/country/1.png') }}" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="body-title-2 mb-3">-15%</div>
                                                            <div class="text-tiny">$27.00</div>
                                                ...
                                                <li class="product-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/4.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                        ...
                                                        <div class="country">
                                                            <img src="{{ asset('asset/remos/images/country/4.png') }}" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="body-title-2 mb-3">-15%</div>
                                                            <div class="text-tiny">$27.00</div>
                                                ...
                                                <li class="product-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/5.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                        ...
                                                        <div class="country">
                                                            <img src="{{ asset('asset/remos/images/country/5.png') }}" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="body-title-2 mb-3">-15%</div>
                                                            <div class="text-tiny">$27.00</div>
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <ul class="flex flex-column justify-between gap10 h-full">
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/country/6.png') }}" alt="">
                                                </div>
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/country/7.png') }}" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/country/8.png') }}" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/country/9.png') }}" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/country/10.png') }}" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                            ...
                                            <li class="country-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/country/11.png') }}" alt="">
                                                </div>
                                                <div class="flex-grow flex items-center justify-between">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-best-shop-sellers">
                                            ...
                                            <ul class="flex flex-column gap18">
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/1.png') }}" alt="">
                                                    </div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/2.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/3.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/4.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/5.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/6.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                                ...
                                                <li class="shop-item">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/shop/7.png') }}" alt="">
                                                    </div>
                                                    <div class="flex-grow flex items-center justify-between gap20">
                                                        <div>
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-product-overview">
                                            ...
                                            <ul class="flex flex-column gap10">
                                                <li class="product-item gap14">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/6.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/7.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/8.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/9.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/10.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                            ...
                                            <ul class="flex flex-column gap18">
                                                <li class="product-item gap14">
                                                    <div class="image small">
                                                        <img src="{{ asset('asset/remos/images/products/11.png') }}" alt="">
                                                    </div>
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image small">
                                                        <img src="{{ asset('asset/remos/images/products/12.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap10">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image small">
                                                        <img src="{{ asset('asset/remos/images/products/13.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap10">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image small">
                                                        <img src="{{ asset('asset/remos/images/products/14.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap10">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image small">
                                                        <img src="{{ asset('asset/remos/images/products/15.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap10">
                                                        <div class="name">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <ul class="flex flex-column gap20 overflow-h">
                                            <li class="comment-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/avatar/user-2.png') }}" alt="">
                                                </div>
                                                <div class="">
                                                    <div class="mb-4 name">
                                            ...
                                            <li class="comment-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/avatar/user-3.png') }}" alt="">
                                                </div>
                                                <div class="">
                                                    <div class="mb-4 name">
                                            ...
                                            <li class="comment-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/avatar/user-4.png') }}" alt="">
                                                </div>
                                                <div class="">
                                                    <div class="mb-4 name">
                                            ...
                                            <li class="comment-item">
                                                <div class="image">
                                                    <img src="{{ asset('asset/remos/images/avatar/user-5.png') }}" alt="">
                                                </div>
                                                <div class="">
                                                    <div class="mb-4 name">
    ...
    <!-- Javascript -->
    <script src="{{ asset('asset/remos/js/jquery.min.js') }}"></script>
    <script src="{{ asset('asset/remos/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('asset/remos/js/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('asset/remos/js/zoom.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/apexcharts.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-1.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-2.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-3.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-4.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-5.js') }}"></script>
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-6.js') }}"></script>
    <!-- <script src="{{ asset('asset/remos/js/switcher.js') }}"></script> -->
    <script src="{{ asset('asset/remos/js/theme-settings.js') }}"></script>
    <script src="{{ asset('asset/remos/js/main.js') }}"></script>
