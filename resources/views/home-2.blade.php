...
<head>
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="{{ ('asset/remos/css/animate.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ ('asset/remos/css/animation.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ ('asset/remos/css/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ ('asset/remos/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ ('asset/remos/css/style.css') }}">



    <!-- Font -->
    <link rel="stylesheet" href="{{ ('asset/remos/font/fonts.css') }}">

    <!-- Icon -->
    <link rel="stylesheet" href="{{ ('asset/remos/icon/style.css') }}">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="{{ ('asset/remos/images/favicon.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{ ('asset/remos/images/favicon.png') }}">
...
<body class="body">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-top-selling-product">
                                            ...
                                            <ul class="flex flex-column gap10">
                                                <li class="product-item gap14">
                                                    <div class="image">
                                                        <img src="{{ asset('asset/remos/images/products/16.png') }}" alt="">
                                                    </div>
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-orders-1">
                                            ...
                                            <ul class="flex flex-column gap18">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/24.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap10">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/25.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap10">
                                                        <div class="name">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="wg-table table-product-overview t1">
                                            ...
                                            <ul class="flex flex-column gap10">
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/26.png') }}" alt="">
                                                    </div>
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/27.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/28.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/29.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
                                                ...
                                                <li class="product-item gap14">
                                                    <div class="image no-bg">
                                                        <img src="{{ asset('asset/remos/images/products/30.png') }}" alt="">
                                                    </div>
                                                    <div class="flex items-center justify-between flex-grow gap20">
                                                        <div class="name">
    ...
    <script src="{{ asset('asset/remos/js/jvectormap-1.2.2.min.js') }}"></script>
    <script src="{{ asset('asset/remos/js/jvectormap-us-lcc.js') }}"></script>
    <script src="{{ asset('asset/remos/js/jvectormap.js') }}"></script>
    ...
    <script src="{{ asset('asset/remos/js/apexcharts/line-chart-7.js') }}"></script>
